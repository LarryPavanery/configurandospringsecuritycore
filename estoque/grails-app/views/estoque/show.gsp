	...
	<body>
		...
		<div id="show-estoque" class="content scaffold-show" role="main">
			...
			<ol class="property-list estoque">
				...
				<g:if test="${estoqueInstance?.nome}">
				<li class="fieldcontain">
					<span id="nome-label" class="property-label"><g:message code="estoque.nome.label" default="Nome" /></span>
					
						<span class="property-value" aria-labelledby="nome-label"><g:fieldValue bean="${estoqueInstance}" field="nome"/></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${estoqueInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
