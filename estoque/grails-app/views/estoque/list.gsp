			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="nome" title="${message(code: 'estoque.nome.label', default: 'Nome')}" />
				...
				<g:each in="${estoqueInstanceList}" status="i" var="estoqueInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${estoqueInstance.id}">${fieldValue(bean: estoqueInstance, field: "nome")}</g:link></td>
